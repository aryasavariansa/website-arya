...
function setupWorkUploadModal() {
    ...
    const removeWorkImageBtn = document.getElementById('removeWorkImageBtn'); // ID unik
    ...
    // Remove image button (dengan ID unik)
    removeWorkImageBtn.addEventListener('click', function() {
